...
const App = () => {
  ...
  return (
    <div>
      ...
      <ul>
        <li>
          <a href={'#/industry-space-map'}><strong>Industry Space Map</strong></a>
          <ul>
            <li>
              <a href={'?shape=convex#/industry-space-map'}>With original convex shapes</a>
            </li>
            <li>
              <a href={'#/industry-space-map'}>With custom cluster shapes</a>
            </li>
          </ul>
        </li>
      </ul>
